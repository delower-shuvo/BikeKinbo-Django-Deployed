...
class Bike(models.Model):
    ...
    tyres_type = models.CharField(choices=tyres_types, max_length=50)
    wheels_type = models.CharField(choices=wheels_types, max_length=50)
    previous_owners = models.IntegerField()
    description = RichTextField(max_length=2000)
    division = models.CharField(choices=divisions, max_length=50)
    district = models.CharField(choices=districts, max_length=50)
